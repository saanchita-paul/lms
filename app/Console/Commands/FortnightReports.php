...
use App\Jobs\FornightMail;

class FortnightReports extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'mailcampaign:fortnight';
     ...
     * @var string
     */
    protected $description = 'Respectively send an exclusive reports to everyone 14 days via email.';
    ...
    public function handle()
    {
        $clinics = Clinic::where('status','Active')->where('emailcampaign',"1")->get();  
         ...
         foreach ($clinics as $key => $value) {
                ...
                $job = (new FornightMail($value))->onQueue('fornightmailcampaign');
