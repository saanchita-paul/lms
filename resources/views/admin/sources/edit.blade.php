...
<div class="card-content">
    <div class="card-header">
        <h5>{{ trans('global.edit') }} {{ trans('cruds.source.title_singular') }}</h5>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sources.update", [$source->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('source_name') ? 'is-invalid' : '' }}" type="text" name="source_name" id="source_name" value="{{ old('source_name', $source->source_name) }}" required>
