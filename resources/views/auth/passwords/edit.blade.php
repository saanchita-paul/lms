...
<div class="row">
                    ...
                    <div class="form-group" style="margin-top:20px;display: none;">
                        ...
                        <div class="switch" id="consultemail_switch">
                            <label>
                              ...
                              <input type="checkbox" name="consultemail" id="consultemail" value="1" {{ auth()->user()->consultemail || old('consultemail', 0) === 1 ? 'checked' : '' }} >
    ...
    <div class="col-md-6">
        ...
        <div class="card-content">
            <div class="card-header">
                <h5>{{ trans('global.change_password') }}</h5>
            </div>
...
@if(auth()->user()->profile_pic)
      var file = {!! json_encode(auth()->user()->profile_pic) !!}
