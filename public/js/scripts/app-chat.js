...
function enter_chat(source) {
   ...
   if (message != "") {
      var html = '<div class="chat chat-right"><div class="chat-avatar"><a class="avatar"><img src="/images/user/microsite-logo.png" class="circle" alt="avatar" /></a></div><div class="chat-body"><div class="chat-text">' + "<p>" + message + "</p>" + "</div></div></div>";
      $(".chat:last-child").parent().append(html);
      $(".message").val("");
      $(".chat-area").scrollTop($(".chat-area > .chats").height());
   }
}
